...
const Workshops = [{
    ...
    summary: 'Helping Families in Silicon Valley is hosting a Q/A webinar during social distancing with guest speaker RN Lorena Torres.',
...
},
{
    ...
    imgUrl: 'https://img.evbuc.com/https%3A%2F%2Fcdn.evbuc.com%2Fimages%2F92912059%2F408932228207%2F1%2Foriginal.20200218-001752?w=1080&auto=format%2Ccompress&q=75&sharp=10&rect=0%2C0%2C890%2C445&s=bea7c2ef362449fb8ef6305721af5e80',
},]
const Blog = () => {
  return (
                                ...
                                <div className="col-md-6">
                                  <div className="row no-gutters border rounded overflow-hidden flex-md-row mb-4 shadow-sm h-md-250 position-relative">
                                    <div className="col p-4 d-flex flex-column position-static">
                                      ...
                                      <a href={workshop.url} className="stretched-link text-primary">Continue reading</a>
                                    </div>
                                    <div className="col-auto d-none d-lg-block">
                                      <img className="bd-placeholder-img mt-4" style={{maxWidth: "200px", maxHeight: "200px"}} alt="" src={workshop.imgUrl}/>
                                    </div>
                                  </div>
                                </div>
                            )
