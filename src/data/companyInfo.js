...
export const robert = {
  imgUrl: './img/avatar/robert-bugarin.jpeg',
  fullName: 'Robert Bugarin',
  title: 'Board Member',
  bio:
    'Roberto Bugarin is an Engineering Assistant professional working with a City in the Peninsula for a Public Works department. In his role, his attention to detail and an inbound of problem solving and critical thinking  platform helps citizens feel safe while attracting visitors. Previously, Roberto worked as a Program Coordinator for a Non-Profit startup. He focused his studies at California State University Sacramento with an emphasis in Civil Engineering.',
  email: 'info@helpingfamiliesinsv.org',
  linkedIn: 'https://www.linkedin.com/in/roberto-bugarin-b2803269/'
};
export const lorena = {
  imgUrl: './img/avatar/lorena-torres.png',
  fullName: 'Lorena Torres',
  title: 'Board Member',
  bio:
    '                      Lorena is a registered nurse currently working in a community health clinic in E.P.A. She received her B.A in Nursing from CSUEB. She has always aspired to make a difference every day by helping others. She has experience working with underserved communities including minorities, homeless and low-income families.',
  email: 'info@helpingfamiliesinsv.org',
  linkedIn: 'https://www.linkedin.com/'
};
export const arturo = {
  imgUrl: './img/avatar/arturo-montoya.jpg',
  fullName: 'Arturo Montoya',
  title: 'Board Member',
  bio:
    'Arturo Montoya is proud to be the first in his family to graduate from college with a B.S. in Computer Engineering from SJSU. Arturo originally comes from a background of working with underserved youth in the south bay and the peninsula. From his time at SJSU emerged with a passion for driving student success through efficiency and innovation.',
  email: 'info@helpingfamiliesinsv.org',
  linkedIn: 'https://www.linkedin.com/in/arturo-montoya-05b69976/'
};

export const teamInfo = [julie, melissa];
export const boardMembers = [lorena, robert, arturo];
